...
class MainGame(QMainWindow, maingame):
    ...
    def __init__(self):
        ...
        self.Widget_Skill.move(800, -1)  # 전투중 스킬 선택시 생성되는 스킬 위젯 위치
...
# ====== 함수 ============================================================================================================
    ...
    # 공격 버튼 시 MonsterImage 버튼 활성화 =========================================================================================

    def Attack_btn(self):
        for mon in range(1,11):
            getattr(self, f'Monster_{mon}_QButton').setEnabled(True)
    ...
    def mon_Turn(self):
        for mon in range(10):   #MonsterImage 버튼 비활성화
