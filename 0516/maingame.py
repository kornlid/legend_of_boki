...
class WindowClass(QMainWindow, form_class):
    ...
    def Show_Dungeon_Entrance(self):
        ...
        self.entrance.move(random.randint(558, 1054), random.randint(168, 662))
    ...
    def check_collision(self, label):
        ...
        self.label_list.remove(self.label_2)  # 배경 라벨 제거 # 현재는 주석처리 해놓음
        self.label_list.remove(self.label_5)  # 캐릭터 라벨 제거 # 현재는 주석처리 해놓음
